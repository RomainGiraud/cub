...
namespace gl
{
	...
	typedef void (CODEGEN_FUNCPTR *PFNCOLORTABLE)(GLenum , GLenum , GLsizei , GLenum , GLenum , const GLvoid *);
	PFNCOLORTABLE ColorTable = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOLORTABLEPARAMETERFV)(GLenum , GLenum , const GLfloat *);
	PFNCOLORTABLEPARAMETERFV ColorTableParameterfv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOLORTABLEPARAMETERIV)(GLenum , GLenum , const GLint *);
	PFNCOLORTABLEPARAMETERIV ColorTableParameteriv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOPYCOLORTABLE)(GLenum , GLenum , GLint , GLint , GLsizei );
	PFNCOPYCOLORTABLE CopyColorTable = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETCOLORTABLE)(GLenum , GLenum , GLenum , GLvoid *);
	PFNGETCOLORTABLE GetColorTable = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETCOLORTABLEPARAMETERFV)(GLenum , GLenum , GLfloat *);
	PFNGETCOLORTABLEPARAMETERFV GetColorTableParameterfv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETCOLORTABLEPARAMETERIV)(GLenum , GLenum , GLint *);
	PFNGETCOLORTABLEPARAMETERIV GetColorTableParameteriv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOLORSUBTABLE)(GLenum , GLsizei , GLsizei , GLenum , GLenum , const GLvoid *);
	PFNCOLORSUBTABLE ColorSubTable = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOPYCOLORSUBTABLE)(GLenum , GLsizei , GLint , GLint , GLsizei );
	PFNCOPYCOLORSUBTABLE CopyColorSubTable = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCONVOLUTIONFILTER1D)(GLenum , GLenum , GLsizei , GLenum , GLenum , const GLvoid *);
	PFNCONVOLUTIONFILTER1D ConvolutionFilter1D = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCONVOLUTIONFILTER2D)(GLenum , GLenum , GLsizei , GLsizei , GLenum , GLenum , const GLvoid *);
	PFNCONVOLUTIONFILTER2D ConvolutionFilter2D = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCONVOLUTIONPARAMETERF)(GLenum , GLenum , GLfloat );
	PFNCONVOLUTIONPARAMETERF ConvolutionParameterf = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCONVOLUTIONPARAMETERFV)(GLenum , GLenum , const GLfloat *);
	PFNCONVOLUTIONPARAMETERFV ConvolutionParameterfv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCONVOLUTIONPARAMETERI)(GLenum , GLenum , GLint );
	PFNCONVOLUTIONPARAMETERI ConvolutionParameteri = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCONVOLUTIONPARAMETERIV)(GLenum , GLenum , const GLint *);
	PFNCONVOLUTIONPARAMETERIV ConvolutionParameteriv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOPYCONVOLUTIONFILTER1D)(GLenum , GLenum , GLint , GLint , GLsizei );
	PFNCOPYCONVOLUTIONFILTER1D CopyConvolutionFilter1D = 0;
	typedef void (CODEGEN_FUNCPTR *PFNCOPYCONVOLUTIONFILTER2D)(GLenum , GLenum , GLint , GLint , GLsizei , GLsizei );
	PFNCOPYCONVOLUTIONFILTER2D CopyConvolutionFilter2D = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETCONVOLUTIONFILTER)(GLenum , GLenum , GLenum , GLvoid *);
	PFNGETCONVOLUTIONFILTER GetConvolutionFilter = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETCONVOLUTIONPARAMETERFV)(GLenum , GLenum , GLfloat *);
	PFNGETCONVOLUTIONPARAMETERFV GetConvolutionParameterfv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETCONVOLUTIONPARAMETERIV)(GLenum , GLenum , GLint *);
	PFNGETCONVOLUTIONPARAMETERIV GetConvolutionParameteriv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETSEPARABLEFILTER)(GLenum , GLenum , GLenum , GLvoid *, GLvoid *, GLvoid *);
	PFNGETSEPARABLEFILTER GetSeparableFilter = 0;
	typedef void (CODEGEN_FUNCPTR *PFNSEPARABLEFILTER2D)(GLenum , GLenum , GLsizei , GLsizei , GLenum , GLenum , const GLvoid *, const GLvoid *);
	PFNSEPARABLEFILTER2D SeparableFilter2D = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETHISTOGRAM)(GLenum , GLboolean , GLenum , GLenum , GLvoid *);
	PFNGETHISTOGRAM GetHistogram = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETHISTOGRAMPARAMETERFV)(GLenum , GLenum , GLfloat *);
	PFNGETHISTOGRAMPARAMETERFV GetHistogramParameterfv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETHISTOGRAMPARAMETERIV)(GLenum , GLenum , GLint *);
	PFNGETHISTOGRAMPARAMETERIV GetHistogramParameteriv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETMINMAX)(GLenum , GLboolean , GLenum , GLenum , GLvoid *);
	PFNGETMINMAX GetMinmax = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETMINMAXPARAMETERFV)(GLenum , GLenum , GLfloat *);
	PFNGETMINMAXPARAMETERFV GetMinmaxParameterfv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNGETMINMAXPARAMETERIV)(GLenum , GLenum , GLint *);
	PFNGETMINMAXPARAMETERIV GetMinmaxParameteriv = 0;
	typedef void (CODEGEN_FUNCPTR *PFNHISTOGRAM)(GLenum , GLsizei , GLenum , GLboolean );
	PFNHISTOGRAM Histogram = 0;
	typedef void (CODEGEN_FUNCPTR *PFNMINMAX)(GLenum , GLenum , GLboolean );
	PFNMINMAX Minmax = 0;
	typedef void (CODEGEN_FUNCPTR *PFNRESETHISTOGRAM)(GLenum );
	PFNRESETHISTOGRAM ResetHistogram = 0;
	typedef void (CODEGEN_FUNCPTR *PFNRESETMINMAX)(GLenum );
	PFNRESETMINMAX ResetMinmax = 0;
	...
	static int LoadCoreFunctions()
	{
		...
		ColorTable = reinterpret_cast<PFNCOLORTABLE>(IntGetProcAddress("glColorTable"));
		if(!ColorTable) ++numFailed;
		ColorTableParameterfv = reinterpret_cast<PFNCOLORTABLEPARAMETERFV>(IntGetProcAddress("glColorTableParameterfv"));
		if(!ColorTableParameterfv) ++numFailed;
		ColorTableParameteriv = reinterpret_cast<PFNCOLORTABLEPARAMETERIV>(IntGetProcAddress("glColorTableParameteriv"));
		if(!ColorTableParameteriv) ++numFailed;
		CopyColorTable = reinterpret_cast<PFNCOPYCOLORTABLE>(IntGetProcAddress("glCopyColorTable"));
		if(!CopyColorTable) ++numFailed;
		GetColorTable = reinterpret_cast<PFNGETCOLORTABLE>(IntGetProcAddress("glGetColorTable"));
		if(!GetColorTable) ++numFailed;
		GetColorTableParameterfv = reinterpret_cast<PFNGETCOLORTABLEPARAMETERFV>(IntGetProcAddress("glGetColorTableParameterfv"));
		if(!GetColorTableParameterfv) ++numFailed;
		GetColorTableParameteriv = reinterpret_cast<PFNGETCOLORTABLEPARAMETERIV>(IntGetProcAddress("glGetColorTableParameteriv"));
		if(!GetColorTableParameteriv) ++numFailed;
		ColorSubTable = reinterpret_cast<PFNCOLORSUBTABLE>(IntGetProcAddress("glColorSubTable"));
		if(!ColorSubTable) ++numFailed;
		CopyColorSubTable = reinterpret_cast<PFNCOPYCOLORSUBTABLE>(IntGetProcAddress("glCopyColorSubTable"));
		if(!CopyColorSubTable) ++numFailed;
		ConvolutionFilter1D = reinterpret_cast<PFNCONVOLUTIONFILTER1D>(IntGetProcAddress("glConvolutionFilter1D"));
		if(!ConvolutionFilter1D) ++numFailed;
		ConvolutionFilter2D = reinterpret_cast<PFNCONVOLUTIONFILTER2D>(IntGetProcAddress("glConvolutionFilter2D"));
		if(!ConvolutionFilter2D) ++numFailed;
		ConvolutionParameterf = reinterpret_cast<PFNCONVOLUTIONPARAMETERF>(IntGetProcAddress("glConvolutionParameterf"));
		if(!ConvolutionParameterf) ++numFailed;
		ConvolutionParameterfv = reinterpret_cast<PFNCONVOLUTIONPARAMETERFV>(IntGetProcAddress("glConvolutionParameterfv"));
		if(!ConvolutionParameterfv) ++numFailed;
		ConvolutionParameteri = reinterpret_cast<PFNCONVOLUTIONPARAMETERI>(IntGetProcAddress("glConvolutionParameteri"));
		if(!ConvolutionParameteri) ++numFailed;
		ConvolutionParameteriv = reinterpret_cast<PFNCONVOLUTIONPARAMETERIV>(IntGetProcAddress("glConvolutionParameteriv"));
		if(!ConvolutionParameteriv) ++numFailed;
		CopyConvolutionFilter1D = reinterpret_cast<PFNCOPYCONVOLUTIONFILTER1D>(IntGetProcAddress("glCopyConvolutionFilter1D"));
		if(!CopyConvolutionFilter1D) ++numFailed;
		CopyConvolutionFilter2D = reinterpret_cast<PFNCOPYCONVOLUTIONFILTER2D>(IntGetProcAddress("glCopyConvolutionFilter2D"));
		if(!CopyConvolutionFilter2D) ++numFailed;
		GetConvolutionFilter = reinterpret_cast<PFNGETCONVOLUTIONFILTER>(IntGetProcAddress("glGetConvolutionFilter"));
		if(!GetConvolutionFilter) ++numFailed;
		GetConvolutionParameterfv = reinterpret_cast<PFNGETCONVOLUTIONPARAMETERFV>(IntGetProcAddress("glGetConvolutionParameterfv"));
		if(!GetConvolutionParameterfv) ++numFailed;
		GetConvolutionParameteriv = reinterpret_cast<PFNGETCONVOLUTIONPARAMETERIV>(IntGetProcAddress("glGetConvolutionParameteriv"));
		if(!GetConvolutionParameteriv) ++numFailed;
		GetSeparableFilter = reinterpret_cast<PFNGETSEPARABLEFILTER>(IntGetProcAddress("glGetSeparableFilter"));
		if(!GetSeparableFilter) ++numFailed;
		SeparableFilter2D = reinterpret_cast<PFNSEPARABLEFILTER2D>(IntGetProcAddress("glSeparableFilter2D"));
		if(!SeparableFilter2D) ++numFailed;
		GetHistogram = reinterpret_cast<PFNGETHISTOGRAM>(IntGetProcAddress("glGetHistogram"));
		if(!GetHistogram) ++numFailed;
		GetHistogramParameterfv = reinterpret_cast<PFNGETHISTOGRAMPARAMETERFV>(IntGetProcAddress("glGetHistogramParameterfv"));
		if(!GetHistogramParameterfv) ++numFailed;
		GetHistogramParameteriv = reinterpret_cast<PFNGETHISTOGRAMPARAMETERIV>(IntGetProcAddress("glGetHistogramParameteriv"));
		if(!GetHistogramParameteriv) ++numFailed;
		GetMinmax = reinterpret_cast<PFNGETMINMAX>(IntGetProcAddress("glGetMinmax"));
		if(!GetMinmax) ++numFailed;
		GetMinmaxParameterfv = reinterpret_cast<PFNGETMINMAXPARAMETERFV>(IntGetProcAddress("glGetMinmaxParameterfv"));
		if(!GetMinmaxParameterfv) ++numFailed;
		GetMinmaxParameteriv = reinterpret_cast<PFNGETMINMAXPARAMETERIV>(IntGetProcAddress("glGetMinmaxParameteriv"));
		if(!GetMinmaxParameteriv) ++numFailed;
		Histogram = reinterpret_cast<PFNHISTOGRAM>(IntGetProcAddress("glHistogram"));
		if(!Histogram) ++numFailed;
		Minmax = reinterpret_cast<PFNMINMAX>(IntGetProcAddress("glMinmax"));
		if(!Minmax) ++numFailed;
		ResetHistogram = reinterpret_cast<PFNRESETHISTOGRAM>(IntGetProcAddress("glResetHistogram"));
		if(!ResetHistogram) ++numFailed;
		ResetMinmax = reinterpret_cast<PFNRESETMINMAX>(IntGetProcAddress("glResetMinmax"));
		if(!ResetMinmax) ++numFailed;
	...
	namespace sys
	{
		...
		{
			const char *temp = (const char *)GetString(VERSION);
